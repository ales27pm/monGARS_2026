...
enum ApprovalTupleHasher {
    ...
    static func normalizedJSON(_ text: String) -> String {
        ...
        return canonicalJSONString(normalizedJSONObject(from: trimmed), defaultText: trimmed)
    }
    ...
    static func canonicalJSONString(_ dictionary: [String: Any]) -> String {
        canonicalJSONString(canonicalObject(dictionary), defaultText: "{}")
    }

    private static func canonicalJSONString(_ object: Any, defaultText: String) -> String {
