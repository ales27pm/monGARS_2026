...
- Settings screen for provider selection, provider capability flags, autonomy level, Network, Weather, Web, Documents/RAG, Apple Integrations, Developer local-network policy, speech permission, and reset.
