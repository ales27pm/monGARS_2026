...
- Settings screen for provider selection, provider capability flags, autonomy level, network access controls, remote endpoint/model/API key, weather endpoint/API key/units, timeout/retry controls, generic HTTP headers, connection testing, privacy guidance, and reset.
